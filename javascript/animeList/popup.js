...
delay(function () {
    ...
    let divCardsTable = document.getElementsByClassName('table__title');
    ...
    Array.from(divCardsTable).forEach(item => {
        item.addEventListener('click', function() {
            ...
            const idCard = item.parentNode.childNodes[3].innerHTML;
